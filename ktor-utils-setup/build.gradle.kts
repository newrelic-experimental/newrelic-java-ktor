// Build.gradle generated for instrumentation module ktor-utils-setup
...
tasks.jar {
    manifest {
        attributes(
            "Implementation-Title" to "com.newrelic.instrumentation.labs.ktor-utils-setup",
            "Implementation-Vendor" to "New Relic Labs",
            "Implementation-Vendor-Id" to "com.newrelic.labs",
            "Implementation-Version" to 1.0,
            "Agent-Class" to "com.newrelic.instrumentation.labs.ktor.utils.KtorUtilsPremain",
         )
    }
}
