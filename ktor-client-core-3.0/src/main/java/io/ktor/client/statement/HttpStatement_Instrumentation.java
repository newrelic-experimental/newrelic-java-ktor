...
public class HttpStatement_Instrumentation {
    ...
    @Trace(dispatcher = true)
    public Object fetchStreamingResponse(Continuation<? super HttpResponse> continuation) {
        return Weaver.callOriginal();
    }

    @Trace(dispatcher = true)
    public Object fetchResponse(Continuation<? super HttpResponse>  continuation) {
        return Weaver.callOriginal();
    }
