...
import com.newrelic.instrumentation.labs.ktor.jetty.KtorJettyHeaders;
import com.newrelic.labs.instrumentation.ktor.jetty.Utils;
import org.eclipse.jetty.server.Request;
import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;
import io.ktor.server.application.ApplicationCall;

@Weave(originalName = "io.ktor.server.jetty.JettyKtorHandler")
public abstract class JettyKtorHandler_Instrumentation {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
        ...
        traced.addCustomAttribute("Server-Type", "Jetty");
        ...
        if (transactionName != null && !transactionName.isEmpty()) {
            transaction.setTransactionName(TransactionNamePriority.CUSTOM_LOW, false, "KtorJetty", transactionName);
        }
