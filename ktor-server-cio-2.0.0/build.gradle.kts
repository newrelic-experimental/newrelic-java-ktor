// Build.gradle generated for instrumentation module ktor-server-cio-2.0.0
...
tasks.jar {
  manifest {
    attributes (
        "Implementation-Title" to "com.newrelic.instrumentation.labs.ktor-server-cio-2.0.0",
