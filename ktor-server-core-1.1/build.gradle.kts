...
tasks.jar {
  manifest {
    attributes(
        "Implementation-Title" to  "com.newrelic.instrumentation.labs.ktor-server-core-1.1",
...
verifyInstrumentation {
  passesOnly("io.ktor:ktor-server-core:[1.0.0,1.2.3)")
    fails("io.ktor:ktor-server-core:1.1.0")
   excludeRegex(".*rc.*")
   excludeRegex(".*beta.*")
}
