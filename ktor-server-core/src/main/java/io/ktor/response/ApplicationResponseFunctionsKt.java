...
public class ApplicationResponseFunctionsKt {
	...
	public static Object respondWrite(ApplicationCall call, ContentType contextType, HttpStatusCode code, Function2<? super java.io.Writer, ? super Continuation<? super Unit>, ? extends Object> f, Continuation<? super Unit> continuation) {
		return Weaver.callOriginal();
	}
